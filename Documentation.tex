...
\end{verbatim}
%\verb|xml_count(s : GNAT.Sockets.Stream_Access)|\\
...
procedure html_show_config(s : GNAT.Sockets.Stream_Access;
                           ...
                           p : web_common.params.Map);
\end{verbatim}
%\verb|html_show_config(s : GNAT.Sockets.Stream_Access)|\\
...
procedure target(s : GNAT.Sockets.Stream_Access;
                 ...
                 p : web_common.params.Map);
\end{verbatim}
%\verb|target(s : GNAT.Sockets.Stream_Access; p : web_common.params.Map)|\\
...
procedure html_reload_config(s : GNAT.Sockets.Stream_Access;
                             ...
                             p : web_common.params.Map);
\end{verbatim}
%\verb|html_reload_config(s : GNAT.Sockets.Stream_Access)|\\
